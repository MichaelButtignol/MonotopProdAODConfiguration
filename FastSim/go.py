...
print "Leptonic=1 or Hadronic=2 ?"
allowed_answers=['1','2']
answer=""
...
########### WHEN USING SEVERAL LHE FILES PER BENCHMARK ############
#
#print "Which number of production do you want ? 1 - 100 "
#good_answer=False
#while not good_answer:
#    answer=raw_input("Answer : ")
#    try:
...
#number_word=number_word.replace('.0','')
#
#if model==1 or model==2:
#    workdir = "prod_S"+str(model)+"_mres"+mass_res_word+"_mchi"+mass_chi_word+"_"+number_word
#else:
#    workdir = "prod_S"+str(model)+"_mchi"+mass_chi_word+"_"+number_word
#
#
###################################################################
...
#os.system('cp '+currentdir+'/pythia_card.dat '+currentdir+'/'+workdir+'/')
...
for njet in range(0,njets):
    ...
    for line in input:
        ...
        words = line2.split()
        if len(words)>=3:
            if words[1].lower()=='block' and words[2].lower()=='iseed':
...
if model==1 or model==2:
    ...
    mg5.write('!cp '+currentdir+'/'+dir_scenario+workdir+'/run_card.dat '+currentdir+'/'+dir_scenario+workdir+'/decay/Cards\n')
...
for njet in range(0,njets):
    ...
    for muf in range(0,njet):
        njet_word += 'j '
    if model==1 and leptonic:
        mg5.write('generate p p > tt fmet '+njet_word+' MT1=0 MT2=0 MT3=2 MT4=0, (tt > bb WW, WW > vv ll)\n')
    elif model==2 and leptonic:
        mg5.write('generate p p > tt fmet '+njet_word+' MT1=0 MT2=0 MT3=0 MT4=2, (tt > bb WW, WW > vv ll)\n')
    elif model==3 and leptonic:
        mg5.write('generate p p > tt smet '+njet_word+' MT1=2 MT2=0 MT3=0 MT4=0, (tt > bb WW, WW > vv ll)\n')
    elif model==4 and leptonic:
        mg5.write('generate p p > tt vmet '+njet_word+' MT1=0 MT2=2 MT3=0 MT4=0, (tt > bb WW, WW > vv ll)\n')
    elif model==1 and not leptonic:
        mg5.write('generate p p > tt fmet '+njet_word+' MT1=0 MT2=0 MT3=2 MT4=0, (tt > bb WW, WW > j j)\n')
    elif model==2 and not leptonic:
        mg5.write('generate p p > tt fmet '+njet_word+' MT1=0 MT2=0 MT3=0 MT4=2, (tt > bb WW, WW > j j)\n')
    elif model==3 and not leptonic:
        mg5.write('generate p p > tt smet '+njet_word+' MT1=2 MT2=0 MT3=0 MT4=0, (tt > bb WW, WW > j j)\n')
    elif model==4 and not leptonic:
        mg5.write('generate p p > tt vmet '+njet_word+' MT1=0 MT2=2 MT3=0 MT4=0, (tt > bb WW, WW > j j)\n')
...
#    mg5.write('!cp '+currentdir+'/'+workdir+'/pythia_card.dat '+currentdir+'/'+workdir+'/prod_'+str(njet)+'j/Cards\n')
    mg5.write('launch\n')
    mg5.close()
...
print "Producing events with Pythia8 ..."    
for njet in range(0,njets):
    os.system(currentdir+'/pythia8170/examples/main41.exe '+currentdir+'/'+dir_scenario+workdir+'/prod_'+str(njet)+'.lhe '+currentdir+'/'+dir_scenario+workdir+'/prod_'+str(njet)+'.hepmc')


print "Producing events with DelphesFAC1 ..."
input=open(currentdir+'/'+dir_scenario+workdir+'/prod.list','w')
for njet in range(0,njets):
    input.write(currentdir+'/'+dir_scenario+workdir+'/prod_'+str(njet)+'.hepmc\n')
input.close()

import shutil
shutil.copytree(currentdir+'/Delphes/data',currentdir+'/'+dir_scenario+workdir+'/data')
os.system('cd '+currentdir+'/'+dir_scenario+workdir+'/; '+currentdir+'/Delphes/Delphes '+currentdir+'/'+dir_scenario+workdir+'/prod.list '+currentdir+'/'+dir_scenario+workdir+'/prod.root '+currentdir+'/Delphes/data/IPHC.dat')

#final rename
os.system('mv '+currentdir+'/'+dir_scenario+workdir+'/prod_0.lhe '+currentdir+'/'+dir_scenario+workdir+'/'+workdir+'.lhe')
os.system('mv '+currentdir+'/'+dir_scenario+workdir+'/prod.root '+currentdir+'/'+dir_scenario+workdir+'/'+workdir+'.root')

#final copy
#if leptonic:
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.lhe /dpm/in2p3.fr/home/cms/econte//monotop/signal_leptonic/8TeV/' )
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.root /dpm/in2p3.fr/home/cms/econte//monotop/signal_leptonic/8TeV/' )
#else:
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.lhe /dpm/in2p3.fr/home/cms/econte//monotop/signal_hadronic/8TeV/' )
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.root /dpm/in2p3.fr/home/cms/econte//monotop/signal_hadronic/8TeV/' )
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.lhe /dpm/in2p3.fr/home/cms/econte//monotop/signal_hadronic/8TeV/' )
#    os.system('rfcp '+currentdir+'/'+workdir+'/'+workdir+'.root /dpm/in2p3.fr/home/cms/econte//monotop/signal_hadronic/8TeV/' )
#    
#os.system('rm -r '+currentdir+'/'+workdir+'/')
