...
# with command line options: reco -s RAW2DIGI,RECO --filein file:prod_S1_HLT.root --fileout file:RECO_test.root --conditions START53_V26::All
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:prod_S1_HLT.root')
)
